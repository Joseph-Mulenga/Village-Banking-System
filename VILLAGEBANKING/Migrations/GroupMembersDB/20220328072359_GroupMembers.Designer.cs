...
namespace VILLAGEBANKING.Migrations.GroupMembersDB
{
    ...
    [Migration("20220328072359_GroupMembers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.GroupMembersModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.GroupModel", b =>
                {
                    b.Property<int>("GroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.GroupMembersModel", b =>
                {
                    b.HasOne("Core.Models.GroupModel", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.GroupModel", b =>
                {
                    b.HasOne("Core.Models.LoanEligibilityModel", "LoanEligibility")
                        .WithMany()
